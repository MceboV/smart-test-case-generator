...
async def generate_test_cases_with_image(
    ...
    # Build GPT-4o request with image and prompt
    messages = [
        {"role": "system", "content": "You are a helpful AI Test Case Generator. Generate test cases with title, steps, expected result, priority, and area path."},
        {
            "role": "user",
            "content": [
                {"type": "text", "text": f"The user story is:\n{user_story}"},
